...
<body>
  ...
  <section class="main">
    <div class='contenedor'>
      ...
      <form action="../php/clientes.php" onsubmit="return validacion()" method="post">
       <table align='center' cellspacing=8 >
         ...
         <tr>
           <th align='right'><label for="Ingrese telefono">Telefono:</label></th>
         ...
         <tr>
           ...
           <td><input type="date" placeholder="Año-mes-dia" name="nacimiento"  ></td>
         </tr>
         <tr>
           <th align='right'><label for="vinculacion">Fecha de vinculacion:</label></th>
           <td><input type="date" placeholder="Año-mes-dia" name="vinculacion" ></td>
         </tr>
         <tr>
         ...
         <tr>
           <td align='right'  colspan='2'>
             ...
             <a class='btn-a' href='../tablas/clientestabla.php'>Volver</a>
           </td>
        </tr>
       </table>
      </form>
