...
<html>
  ...
  <body>
    ...
    $array=pg_fetch_array($result1);
        ...
        $query3 = "select * from ciudades where codigo_ciudad = $array[9]";
        ...
        $ciudad=pg_fetch_array($result3);
               ...
               echo "
                 ...
                 <div class='contenedor'>
                    ...
                    <form action='../php/modificarCliente.php' onsubmit='return validacion()' method='post'>
                    <table align='center' cellspacing=8 >
                      ...
                      <tr>
                        ...
                        <td><input  type='text' name='dir' value='$array[5]'/></td>
                      </tr>
                      <tr>
                        <th align='right'><label for='telefono'>Telefono:</label></th>
                        <td><input type='text' name='tel'  onkeypress='return soloNumeros(event)' value='$array[6]'/></td>
                      </tr>
                      <tr>
                        <th align='right'><label for='nacimiento'>Fecha de nacimiento:</label></th>
                        <td><input type='date' name='fechan' value='$array[7]'/></td>
                      </tr>
                      <tr>
                        <th align='right'><label for='vinculacion'>Fecha de vinculacion:</label></th>
                        <td><input type='date' name='fechav' value='$array[8]'/></td>
                      </tr>
                      <tr>
                    ...
                    echo " </select>
                      ...
                      <tr>
                        <td align='right'  colspan='2'>
                          ...
                          <a class='btn-a' href='../tablas/clientestabla.php'>Cancelar</a>
                        </td>
                     </tr>
                    </table>
                 </div>
