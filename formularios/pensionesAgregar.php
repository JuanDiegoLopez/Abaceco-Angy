...
<head>
  ...
  <title>Formulario Pensiones</title>
</head>
<body>
  <header>
    <?php
  ...
  <section class="main">
    ...
    <div class='contenedor'>
      ...
      <form action="../php/pensiones.php" method="post" onsubmit="return validacion()">
       <table align='center' cellspacing=8 >
		...
		<tr>
         ...
         <tr>
           <th align='right'><label for="direccion">Dirección:</label></th>
        ...
        <tr>
         ...
         <tr>
           <td align='right'  colspan='2'>
			 ...
			 <a class='btn-a' href='../tablas/pensionesTabla.php'>Volver</a>
           </td>
        </tr>
       </table>
      </form>
