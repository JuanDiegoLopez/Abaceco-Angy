		...
		$array = pg_fetch_array($result1);
							 echo "
								 ...
								 <div class='contenedor'>
										<h1 align='center'> Modificar EPS </h1>
										<form action='../php/modificarEps.php' onsubmit='return validacion()' method='post'>
										<table align='center' cellspacing=8 >
											...
											<tr>
												...
												<td><input type='text' name='telefono' value='$array[1]' onkeypress='return soloNumeros(event)'/></td>
											</tr>
											<tr>
												<th align='right'><label for='direccion'>Direccion:</label></th>
												<td><input type='text'name='direccion' value='$array[2]'/></td>
											</tr>
											<tr>
												<td><br></td>
											</tr>
											<tr>
												<td align='right'  colspan='2'>
													...
													<a class='btn-a' href='../tablas/epsTabla.php'>Cancelar</a>
												</td>
										 </tr>
										</table>
								 </div>
